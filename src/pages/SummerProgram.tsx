...
const SummerProgram = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <section className="bg-robotics-navy text-white py-12">
        <div className="container">
          <div className="flex items-center gap-4 mb-6">
            <Link to="/">
              <Button variant="outline" className="bg-transparent border-white text-white hover:bg-white hover:text-robotics-navy">
              ...
              <Card>
                ...
                <CardContent className="max-h-[600px] overflow-y-auto pr-2">
                  <Accordion type="single" collapsible className="w-full">
                    ...
                    {/* Continue with all 8 weeks as in original ProgramDetails */}
